...
from engiopt.lvae.aes import LeastVolumeAE_DynamicPruning
...
@dataclass
class Args:
    """Command-line arguments for LVAE training."""
...
if __name__ == "__main__":
    ...
    # Initialize the LVAE with dynamic pruning
    ...
    for epoch in range(args.n_epochs):
        ...
        if args.save_model and epoch == args.n_epochs - 1:
            ckpt_lvae = {
                ...
                "pruning_mask": lvae.pruning_mask.cpu(),
                "pruning_frozen_z": lvae.frozen_z.cpu(),
                "args": vars(args),
            }
            ...
            save_checkpoint_package(
                ...
                algo=args.algo,
                seed=args.seed,
                checkpoint_files={"lvae.pth": "lvae.pth"},
                run_config=vars(args),
                **checkpoint_identity(args),
                primary_files=["lvae.pth"],
            )
