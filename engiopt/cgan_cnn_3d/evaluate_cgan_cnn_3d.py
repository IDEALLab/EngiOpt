...
if __name__ == "__main__":
    ...
    if args.checkpoint_path is not None:
        ...
        if args.wandb_entity is not None:
            artifact_path = (
                f"{args.wandb_entity}/{args.wandb_project}/{args.problem_id}_cgan_cnn_3d_generator_3d:seed_{seed}"
            )
        else:
    ...
    z = th.randn((args.n_samples, int(run_config["latent_dim"]), 1, 1, 1), device=device, dtype=th.float)
