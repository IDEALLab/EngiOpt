"""Evaluation for a single seed of GAN CNN 2D."""
...
if __name__ == "__main__":
    ...
    # reshape to (batch, cond, 1, 1)
    conditions_tensor = conditions_tensor.unsqueeze(-1).unsqueeze(-1)

    # Load GAN-CNN 2D generator artifact from WandB
    ...
    # Generate designs
    z = th.randn(
        (args.n_samples, run.config["latent_dim"], 1, 1),
        device=device,
        dtype=th.float32,
    )
